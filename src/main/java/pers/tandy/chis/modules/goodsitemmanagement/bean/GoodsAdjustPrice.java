...
public class GoodsAdjustPrice implements Serializable {
    ...
    @Min(0)
    @NotNull
    private Float newRetailPrice;

    @Digits(integer = 8, fraction = 4)
    @Min(0)
    @NotNull
    private Float originalSplitPrice;

    @Digits(integer = 8, fraction = 4)
    @Min(0)
    @NotNull
    private Float newSplitPrice;
    ...
    public Float getNewRetailPrice() {
        return newRetailPrice;
    }

    public void setNewRetailPrice(Float newRetailPrice) {
        this.newRetailPrice = newRetailPrice;
    }

    public Float getOriginalSplitPrice() {
        return originalSplitPrice;
    }

    public void setOriginalSplitPrice(Float originalSplitPrice) {
        this.originalSplitPrice = originalSplitPrice;
    }

    public Float getNewSplitPrice() {
        return newSplitPrice;
    }

    public void setNewSplitPrice(Float newSplitPrice) {
