...
public class PurchaseOrder implements Serializable {
    ...
    public Short getPlanQuantity() {
        return planQuantity;
    }

    public void setPlanQuantity(Short planQuantity) {
        this.planQuantity = planQuantity;
    }

    public Short getPurchaseQuantity() {
        return purchaseQuantity;
    }

    public void setPurchaseQuantity(Short purchaseQuantity) {
