...
import pers.tandy.chis.modules.membermanagement.dao.MemberMapper;
import pers.tandy.chis.modules.membermanagement.service.CommitteeService;
...
public class MemberServiceImpl implements MemberService {
    ...
    @Override
    public void updateBalanceAndPoints(Integer id, Float balance, Integer points) {
        try {
    ...
    @Override
    public void updateBalanceForDeposit(Integer id, Float balance) {
        try {
