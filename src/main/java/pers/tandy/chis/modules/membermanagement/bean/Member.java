...
public class Member implements Serializable {
    ...
    public Float getGivenBalance() {
        return givenBalance;
    }

    public void setGivenBalance(Float givenBalance) {
    ...
    public String toString() {
        return "Member{" +
                ...
                ", mrmTownshipId=" + mrmTownshipId +
                ", mrmCommitteeId=" + mrmCommitteeId +
                ", address='" + address + '\'' +
                ", dpAddress='" + dpAddress + '\'' +
                ...
                ", mrmMemberTypeId=" + mrmMemberTypeId +
                ", eMail='" + eMail + '\'' +
                ", notes='" + notes + '\'' +
                ", balance=" + balance +
                ...
                ", points=" + points +
                ", imageUrl='" + imageUrl + '\'' +
                ", committeeArchiveIndex=" + committeeArchiveIndex +
                ", archiveNo='" + archiveNo + '\'' +
                ", geneticIllness='" + geneticIllness + '\'' +
                ", kitchenExhaustId=" + kitchenExhaustId +
                ", fuelTypeId=" + fuelTypeId +
                ", waterSourceId=" + waterSourceId +
                ", toiletTypeId=" + toiletTypeId +
                ", livestockFenceId=" + livestockFenceId +
