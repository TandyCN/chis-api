...
import pers.tandy.chis.main.authority.component.ShiroFilterChainDefinitionMapUpdater;
...
import pers.tandy.chis.modules.systemmanagement.dao.AuthcMapper;
...
public class AuthcServiceImpl implements AuthcService {
    ...
    public List<Authc> getAll() {
        AuthcExample example = new AuthcExample();
        example.setOrderByClause("module_order, menu_order, path_order");
        return authcMapper.selectByExample(example);
    }
