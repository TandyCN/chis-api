...
import pers.tandy.chis.modules.inventorymanagement.dao.SelfUsedRecordMapper;
import pers.tandy.chis.modules.inventorymanagement.service.InventoryService;
import pers.tandy.chis.modules.inventorymanagement.service.SelfUsedRecordService;
...
public class SelfUsedRecordServiceImpl implements SelfUsedRecordService {
    ...
    public void approved(String lsh) {
        ...
        for (Inventory inventory : inventoryList) {
            // 获取对应库存ID的领用出库数量
            short quantity = selfUsedRecordMap.get(inventory.getId()).getQuantity();
            // 判断数量是否足够
