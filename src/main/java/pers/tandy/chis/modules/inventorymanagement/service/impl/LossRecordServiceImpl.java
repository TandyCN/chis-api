...
import pers.tandy.chis.modules.inventorymanagement.dao.LossRecordMapper;
import pers.tandy.chis.modules.inventorymanagement.service.InventoryService;
import pers.tandy.chis.modules.inventorymanagement.service.LossRecordService;
...
public class LossRecordServiceImpl implements LossRecordService {
    ...
    public void saveList(List<LossRecord> lossRecordList) {
        ...
        // 保存记录
        lossRecordMapper.insertList(lossRecordList);
    }
    ...
    public void approved(String lsh) {
        ...
        for (Inventory inventory : inventoryList) {
            // 获取对应库存ID的领用出库数量
            short quantity = lossRecordMap.get(inventory.getId()).getQuantity();
            // 判断数量是否足够
